...
// default
gulp.task("default", ["compile-typescript", "generate-lib.min.css", "generate-lib.js", "watch"]);

// Build with local settings
gulp.task("build-local", ["compile-typescript", "generate-lib.min.css"], function () {
    return build("local", false);
});

// Build with production settings
gulp.task("build-production", ["compile-typescript", "generate-lib.min.css"], function () {
    return build("production", true);
});

// Build with test settings
gulp.task("build-test", ["compile-typescript", "generate-lib.min.css"], function () {
...
// Concat all external css files and minify them into lib.min.css
gulp.task("generate-lib.min.css", ["copy-fonts"], function () {

    var cssmin = require("gulp-cssmin");

    return gulp.src(libMinCssSrc)
...
gulp.task("watch", function () {
    ...
    gulp.watch(libMinCssSrc, ["generate-lib.min.css"]);
