...
--Assign the values
SET @path = 'E:\Databases\Backup\doktorasizlar\Manual\'
SET @dbName = 'doktorasizlar'
...
PRINT CHAR(10) + N'doktorasizlar - "Live - Backup Database.sql" script file has been successfully executed!';
GO
