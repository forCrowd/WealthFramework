...
export class ElementCell extends EntityBase {
    ...
    setNumericValueMultiplied(updateRelated?: any) {
        ...
        if (typeof this.ElementField === "undefined") {
            ...
            //console.log(this.ElementField.Name[0] + "-" + this.ElementItem.Name[0] + " NVMA " + this.numericValue());
            //console.log(this.ElementField.Name[0] + "-" + this.ElementItem.Name[0] + " NVMB " + this.ElementItem.multiplier());
        }
