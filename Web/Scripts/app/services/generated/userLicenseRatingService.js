...
(function () {
    ...
    function userLicenseRatingService(dataContext, logger) {
        ...
        var service = {
            createUserLicenseRating: createUserLicenseRating,
            deleteUserLicenseRating: deleteUserLicenseRating,
            getChanges: getChanges,
            getChangesCount: getChangesCount,
            getUserLicenseRatingSet: getUserLicenseRatingSet,
            getUserLicenseRating: getUserLicenseRating,
        ...
        function getUserLicenseRatingSet(userId, forceRefresh) {
            ...
            function success(response) {
                ...
                logger.logSuccess('Got ' + count + ' userLicenseRating(s)', response, true);
                return response.results;
            }

            function failed(error) {
                var message = error.message || 'UserLicenseRating query failed';
        ...
        function getUserLicenseRating(userLicenseRatingId, forceRefresh) {
            ...
            function failed(error) {
                var message = error.message || 'getUserLicenseRating query failed';
                logger.logError(message, error, true);
            }
        }
