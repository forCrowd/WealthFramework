(function () {
    ...
    function routeConfig($routeProvider, $locationProvider) {
        ...
        $routeProvider
            ...
            .when('/ResourcePoolIndex', { templateUrl: '/ViewsNg/list/resourcePoolIndexList.html', controller: 'resourcePoolIndexListController as vm' })
            .when('/ResourcePoolIndex/new', { templateUrl: '/ViewsNg/edit/resourcePoolIndexEdit.html', controller: 'resourcePoolIndexEditController as vm' })
            .when('/ResourcePoolIndex/edit/:Id', { templateUrl: '/ViewsNg/edit/ResourcePoolIndexEdit.html', controller: 'resourcePoolIndexEditController as vm' })
            ...
            .when('/UserResourcePoolIndex', { templateUrl: '/ViewsNg/list/userResourcePoolIndexList.html', controller: 'userResourcePoolIndexListController as vm' })
            .when('/UserResourcePoolIndex/new', { templateUrl: '/ViewsNg/edit/userResourcePoolIndexEdit.html', controller: 'userResourcePoolIndexEditController as vm' })
            .when('/UserResourcePoolIndex/edit/:Id', { templateUrl: '/ViewsNg/edit/UserResourcePoolIndexEdit.html', controller: 'userResourcePoolIndexEditController as vm' })
            .when('/UserResourcePoolIndexValue', { templateUrl: '/ViewsNg/list/userResourcePoolIndexValueList.html', controller: 'userResourcePoolIndexValueListController as vm' })
            .when('/UserResourcePoolIndexValue/new', { templateUrl: '/ViewsNg/edit/userResourcePoolIndexValueEdit.html', controller: 'userResourcePoolIndexValueEditController as vm' })
            .when('/UserResourcePoolIndexValue/edit/:Id', { templateUrl: '/ViewsNg/edit/UserResourcePoolIndexValueEdit.html', controller: 'userResourcePoolIndexValueEditController as vm' })
