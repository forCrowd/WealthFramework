...
(function () {
    ...
    angular.module('main')
        .factory(serviceId, ['dataContext', '$rootScope', 'logger', userElementFieldIndexService]);

    function userElementFieldIndexService(dataContext, $rootScope, logger) {
        ...
        function getUserElementFieldIndexSet(forceRefresh) {
            ...
            function success(response) {
                ...
                //logger.logSuccess('Got ' + count + ' userElementFieldIndex(s)', response);
