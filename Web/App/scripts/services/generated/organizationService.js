...
(function () {
    ...
    angular.module('main')
        .factory(serviceId, ['dataContext', 'logger', organizationService]);

    function organizationService(dataContext, logger) {
        ...
        function getOrganizationSet(forceRefresh) {
            ...
            function success(response) {
                ...
                logger.logSuccess('Got ' + count + ' organization(s)', response, true);
