...
(function () {
    ...
    angular.module('main')
        .factory(serviceId, ['dataContext', 'logger', elementService]);

    function elementService(dataContext, logger) {
        ...
        function createElement(element) {
            dataContext.createEntity('Element', element);
        }
        ...
        function getElementSet(forceRefresh) {
            ...
            function success(response) {
                ...
                logger.logSuccess('Got ' + count + ' element(s)', response, true);
