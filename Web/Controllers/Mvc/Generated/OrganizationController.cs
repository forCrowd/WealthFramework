...
//        {
//            var organization = unitOfWork.AllLiveIncluding(o => o.Sector, o => o.License, o => o.ResourcePool);
...
//        public async Task<ActionResult> Create([Bind(Include = "Id,ResourcePoolId,SectorId,Name,ProductionCost,SalesPrice,LicenseId,CreatedOn,ModifiedOn,DeletedOn")] OrganizationDto organizationdto)
//        {
...
//            ViewBag.ResourcePoolId = new SelectList(unitOfWork.ResourcePoolSetLive.AsEnumerable(), "Id", "Name", organization.ResourcePoolId);
//            return View(organization);
//        }
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<ActionResult> Edit([Bind(Include = "Id,ResourcePoolId,SectorId,Name,ProductionCost,SalesPrice,LicenseId,CreatedOn,ModifiedOn,DeletedOn")] OrganizationDto organizationdto)
//        {
//            var organization = organizationdto.ToBusinessObject();
