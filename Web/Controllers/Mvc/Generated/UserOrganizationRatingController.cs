...
namespace Web.Controllers.Mvc
{
    public partial class UserOrganizationRatingController : BaseController
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,UserId,OrganizationId,NumberOfSales,QualityRating,EmployeeSatisfactionRating,CustomerSatisfactionRating,CreatedOn,ModifiedOn,DeletedOn")] UserOrganizationRating userorganizationrating)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,UserId,OrganizationId,NumberOfSales,QualityRating,EmployeeSatisfactionRating,CustomerSatisfactionRating,CreatedOn,ModifiedOn,DeletedOn")] UserOrganizationRating userorganizationrating)
        {
            if (ModelState.IsValid)
            {
