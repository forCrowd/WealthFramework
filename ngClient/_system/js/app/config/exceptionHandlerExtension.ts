export function extendHandler($provide: any) {
    $provide.decorator("$exceptionHandler", ["logger", "settings", "$delegate", "$injector", "$window", exceptionHandlerExtension]);
}

function exceptionHandlerExtension(logger: any, settings: any, $delegate: any, $injector: any, $window: any) {

    var exceptionUrl = settings.serviceAppUrl + "/api/Exception/Record";
