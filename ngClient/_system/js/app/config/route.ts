module Main.Config {
    ...
    function routeConfig($locationProvider: any, $routeProvider: any) {
        ...
        $routeProvider
            ...
            .when('/_system/content/contributors', { title: 'Contributors', templateUrl: '/_system/views/content/contributors.html?v=0.64.6', enableDisqus: true, resolve: { validateAccess: ['dataContext', 'locationHistory', 'logger', '$location', '$q', '$route', validateAccess] } })
