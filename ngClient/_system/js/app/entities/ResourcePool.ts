module Main.Entities {
    ...
    function resourcePoolFactory(logger: any) {
        ...
        Object.defineProperty(ResourcePool.prototype, 'UseFixedResourcePoolRate', {
            enumerable: true,
            configurable: true,
            get() { return this.backingFields._useFixedResourcePoolRate; },
            set(value) {
        ...
        Object.defineProperty(ResourcePool.prototype, 'RatingMode', {
            enumerable: true,
            configurable: true,
            get() { return this.backingFields._ratingMode; },
            set(value) {
        ...
        function ResourcePool() {
            ...
            function _init(setComputedFields: any) {
                ...
                if (setComputedFields) {
                    ...
                    // ResourcePool
                    self.UserResourcePoolSet.forEach(userResourcePool => {
                    ...
                    // Fields
                    self.ElementSet.forEach(element => {
                        element.ElementFieldSet.forEach(elementField => {
                            elementField.UserElementFieldSet.forEach(userElementField => {
                            ...
                            elementField.ElementCellSet.forEach(elementCell => {
                                elementCell.UserElementCellSet.forEach(userElementCell => {
            ...
            function mainElement() {
                var result = self.ElementSet.filter(element => element.IsMainElement);
            ...
            function setCurrentUserResourcePoolRate(updateRelated: any) {
            ...
            function setResourcePoolRate(updateRelated: any) {
                updateRelated = typeof updateRelated === 'undefined' ? true : updateRelated;
            ...
            function setResourcePoolRatePercentage(updateRelated: any) {
                updateRelated = typeof updateRelated === 'undefined' ? true : updateRelated;
            ...
            function stripInvalidChars(value: string) {
    ...
    resourcePoolFactory.$inject = ['logger'];

    angular.module('main').factory(factoryId, resourcePoolFactory);
}