module Main.Entities {
    ...
    function enumsFactory(logger: any) {
        ...
        var self = {
            ...
            ElementFieldIndexCalculationType: {},
            ElementFieldIndexSortType: {},
        ...
        function getEnumKey(enumTableKey: any, value: any) {
    ...
    enumsFactory.$inject = ['logger'];

    angular.module('main').factory(factoryId, enumsFactory);
}