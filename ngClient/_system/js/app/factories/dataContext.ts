...
export function dataContext(entityManagerFactory: any, logger: any, settings: any, $http: any, $q: any, $rootScope: any, $timeout: any, $window: any) {

    // Service urls
    var addPasswordUrl = settings.serviceAppUrl + "/api/Account/AddPassword";
    var changeEmailUrl = settings.serviceAppUrl + "/api/Account/ChangeEmail";
    var changePasswordUrl = settings.serviceAppUrl + "/api/Account/ChangePassword";
    var changeUserNameUrl = settings.serviceAppUrl + "/api/Account/ChangeUserName";
    var confirmEmailUrl = settings.serviceAppUrl + "/api/Account/ConfirmEmail";
    var registerUrl = settings.serviceAppUrl + "/api/Account/Register";
    var registerAnonymousUrl = settings.serviceAppUrl + "/api/Account/RegisterAnonymous";
    var resendConfirmationEmailUrl = settings.serviceAppUrl + "/api/Account/ResendConfirmationEmail";
    var resetPasswordUrl = settings.serviceAppUrl + "/api/Account/ResetPassword";
    var resetPasswordRequestUrl = settings.serviceAppUrl + "/api/Account/ResetPasswordRequest";
    var tokenUrl = settings.serviceAppUrl + "/api/Token";
