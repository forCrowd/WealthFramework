...
class KnowledgeIndexController {
    ...
    constructor(dataContext: any, logger: any, resourcePoolFactory: any, $scope: any, $timeout: any) {
        ...
        vm.popularSoftwareLicensesConfig = {
            userName: "sample",
            resourcePoolKey: "Knowledge-Index-Popular-Software-Licenses"
        };
...
export const knowledgeIndex: angular.IComponentOptions = {
    controller: KnowledgeIndexController,
    controllerAs: "vm",
    templateUrl: "/_system/js/app/components/content/knowledgeIndex.html?v=0.65.0"
};
