...
class ResourcePoolManageController {

    static $inject = ["dataContext", "Enums", "logger", "resourcePoolFactory", "$location", "$rootScope", "$routeParams", "$uibModal"];

    constructor(dataContext: any, Enums: any, logger: any, resourcePoolFactory: any, $location: any, $rootScope: any, $routeParams: any, $uibModal: any) {
        ...
        function openRemoveResourcePoolModal() {
            var modalInstance = $uibModal.open({
                ...
                controllerAs: "vm",
                keyboard: false,
                templateUrl: "/_system/js/app/components/resourcePool/resourcePoolRemove.html?v=0.65.0"
            });
...
export const resourcePoolManage: angular.IComponentOptions = {
    controller: ResourcePoolManageController,
    controllerAs: "vm",
    templateUrl: "/_system/js/app/components/resourcePool/resourcePoolManage.html?v=0.65.0"
};
